...
{
	ft_printf(stderr, "[bench] sa: %d | sb: %d | ss: %d\n",
		b->sa, b->sb, b->ss);
	ft_printf(stderr, "[bench] pa: %d | pb: %d\n", b->pa, b->pb);
	ft_printf(stderr, "[bench] ra: %d | rb: %d | rr: %d\n",
		b->ra, b->rb, b->rr);
	ft_printf(stderr, "[bench] rra: %d | rrb: %d | rrr: %d\n",
		b->rra, b->rrb, b->rrr);
}
